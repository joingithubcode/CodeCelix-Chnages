    ...
    <section id="services" className="py-20 bg-gray-50 font-inter">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-6 font-poppins">What We Do</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow duration-300 group cursor-pointer">
            <div className="bg-red-50 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:bg-red-100 transition-colors">
              <i className="ri-code-line text-2xl text-[#922e2e] w-6 h-6 flex items-center justify-center"></i>
            </div>
            ...
            <div className="flex items-center font-dmSans text-[#922e2e] font-medium group-hover:text-[#7a2525] transition-colors">
              Learn More
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow duration-300 group cursor-pointer">
            <div className="bg-red-50 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:bg-red-100 transition-colors">
              <i className="ri-smartphone-line text-2xl text-[#922e2e] w-6 h-6 flex items-center justify-center"></i>
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-4 font-poppins">Mobile Apps</h3>
            <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow duration-300 group cursor-pointer">
            <div className="bg-red-50 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:bg-red-100 transition-colors">
              <i className="ri-cloud-line text-2xl text-[#922e2e] w-6 h-6 flex items-center justify-center"></i>
            </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow duration-300 group cursor-pointer">
            <div className="bg-red-50 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:bg-red-100 transition-colors">
              <i className="ri-database-line text-2xl text-[#922e2e] w-6 h-6 flex items-center justify-center"></i>
            </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow duration-300 group cursor-pointer">
            <div className="bg-red-50 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:bg-red-100 transition-colors">
              <i className="ri-shield-check-line text-2xl text-[#922e2e] w-6 h-6 flex items-center justify-center"></i>
            </div>
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transition-shadow duration-300 group cursor-pointer">
            <div className="bg-red-50 w-16 h-16 rounded-xl flex items-center justify-center mb-6 group-hover:bg-red-100 transition-colors">
              <i className="ri-settings-line text-2xl text-[#922e2e] w-6 h-6 flex items-center justify-center"></i>
            </div>
        ...
        <div className="text-center mt-12">
          <button className="bg-[#922e2e] font-dmSans text-white px-8 py-4 rounded-full hover:bg-[#7a2525] transition-colors font-semibold text-lg whitespace-nowrap cursor-pointer">
            View All Services
          </button>
        </div>
      </div>
